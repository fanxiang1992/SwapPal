...
var CreatePostComponent = (function () {
    ...
    CreatePostComponent.prototype.postInfo = function () {
        ...
        setTimeout(function () { return _this.router.navigate(['post-list']); }, 4000);
    };
        ...
        if (!loginForm.valid) {
            ...
            this.userService.login(loginForm).then(function (res) {
                if (res == null) {
                    ...
                    _this.userService.user = res.email;
...
var PostListComponent = (function () {
    ...
    PostListComponent.prototype.ngOnInit = function () {
        var userEmail = this.userService.user;
